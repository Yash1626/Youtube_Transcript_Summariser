...
# env_path = 'C:/Users/YASHC/OneDrive/Desktop/YASH/YT/.env'  # Change the Path
...
def summarize_with_langchain_and_cohere(transcript, model='command-r-plus'):
    ...
    Add a title to the summary in English. 
    Include an INTRODUCTION, BULLET POINTS if possible, and a CONCLUSION in English.'''
